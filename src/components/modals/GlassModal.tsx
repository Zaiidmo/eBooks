...
export function GlassModal({ trigger, children }: GlassModalProps) {
  return (
    <AlertDialog>
      ...
      <AlertDialogContent className="sm:max-w-[425px] overflow-y-auto max-h-screen md:max-w-screen-md md:mx-auto backdrop-filter backdrop-blur-xl bg-white/60 dark:bg-gray-900/60 border border-gray-200 dark:border-gray-700 shadow-lg rounded-xl">
